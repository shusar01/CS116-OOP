/*
  choice5.cpp
  Purpose - To return to the user all the  Red wines in a descending order by price
...
void choice5(vector <Wine *> & Winest)
{
	...
	cout << "Below are the Red wines with the price selections in descending order: \n" << endl;
